...
class vehicle implements Serializable // using pre defined class in java
{
String name;
float mileage;
int price;
vehicle(String name, float mileage, int price) //parameterized constructor
{
this.name=name;
...
float mileage3;
int price3;                                                                   //input
System.out.println("Enter the name , Milage and price of the first car");
...
vehicle obj3=new vehicle(name3,mileage3,price3);                                    //writing all the object in record.doc file
try{
...
if(price1>price2 && price1>price3)        //printing data from record.doc with respect to price condition
{
try{
FileOutputStream fos=new FileOutputStream("record.doc");
ObjectOutputStream oos=new ObjectOutputStream(fos);
...
else if(price2>price1 && price1>price3)
{
try{
FileOutputStream fos=new FileOutputStream("record.doc");
ObjectOutputStream oos1=new ObjectOutputStream(fos);
